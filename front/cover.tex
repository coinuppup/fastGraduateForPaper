...
\hitsetup{
  ...
  % 论文类型
  %===========
  % 毕业论文勾选 design=false，毕业设计勾选 design=true
  design=false,
  %
  %=====
  % 秘级
  ...
  cauthor={张三},
  csupervisor={王鸿鹏教授},
  cassosupervisor={夏文教授}, % 副指导老师，如不需要可以注释
  ...
  eauthor={Zhang San},
  esupervisor={Professor Wang Hongpeng},
  eassosupervisor={Professor Xia Wen},
  % 日期自动生成，若需指定按如下方式修改：
  edate={May, 2026},
